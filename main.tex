...
\begin{abstract}
  ...
  exists a network with such hybridization number. We also created a software tool called PhyloSAT which implements our algorithm.
...
\begin{figure}[t]
  ...
  \begin{minipage}[b]{0.40\linewidth}
    ...
    \centering{\\ (b) A hybridization network for the trees from Fig.~\ref{network-example}~(a)}
  \end{minipage}
...
in cases when heuristic lower bound is equal to the actual minimal hybridization number. Besides we found 
