...
To solve the generated Boolean formula we use a SAT-solver CryptoMiniSat\footnote[1]{\url{http://www.msoos.org/cryptominisat4/}}.
...
8 more test cases had isomorphic trees in input, so they had an obvious answer.
